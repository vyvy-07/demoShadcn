    ...
    categories: [
      {
        ...
        subCates: [
          ...
          { id: '88fcb2e9a', name: 'Sơ đồ tổ chức', alias: 'so-do-to-chuc' },
          { id: 'df3d4c7ee', name: 'Bản đồ du lịch', alias: 'ban-do-du-lich' },
          {
            id: 'b2e69ddf4',
      ...
      },
      {
        ...
        subCates: [
          ...
          { id: 'd47f2231a', name: 'Văn hóa xã hội', alias: 'van-hoa-xa-hoi' },
          { id: '90e4ab9c3', name: 'Tin trong nước', alias: 'tin-trong-nuoc' },
          { id: '7d3f1a83b', name: 'Tin ngoài nước', alias: 'tin-ngoai-nuoc' },
          {
            id: '3b7fdcee7',
            name: 'Xây dựng chính quyền',
            alias: 'xay-dung-chinh-quyen',
          },
          { id: 'f9b374812', name: 'Xây dựng Đảng', alias: 'xay-dung-dang' },
        ],
      },
      {
        id: '84b1623ca',
        ...
        subCates: [
          ...
          { id: '3cfa2d1bb', name: 'Thông tin tiện ích', alias: 'tien-ich' },
          { id: 'ab3d1cf2a', name: 'Thông tin chuyên đề', alias: 'chuyen-de' },
          { id: 'f8a12f0de', name: 'Thông tin chỉ đạo', alias: 'chi-dao' },
          {
            id: 'e3cd11af0',
          ...
          { id: '093cf7d84', name: 'Liên hệ', alias: 'lien-he' },
          { id: '2f6ecaa72', name: 'Ý kiến xử lý', alias: 'y-kien-xu-ly' },
        ],
      },
      {
        id: 'cc3f1a0b2',
      ...
      },
      {
        ...
        subCates: [
          { id: '9e3a1bf32', name: 'Audio', alias: 'audio' },
          { id: '61f9c845e', name: 'Video', alias: 'video' },
          { id: 'b5f77ac94', name: 'Thư viện ảnh', alias: 'thu-vien-anh' },
          {
            id: '497cda82c',
